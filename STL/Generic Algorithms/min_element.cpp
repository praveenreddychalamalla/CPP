/**
    ...
    This code demonstrates the usage of min_element function.
*/
#include<iostream>
#include<algorithm>
using namespace std;
/*
    min_element() can be used with containers which support Bi-directional iterators.
    ...
    min_element() returns an iterator pointing to the minimum element in the range [first,last). The comparisions are performed using < (Default)
    or comp
