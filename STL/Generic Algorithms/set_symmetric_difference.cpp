/**
    ...
    This code demonstrates the usage of set_symmetric_difference function.
*/
#include<bits/stdc++.h>
using namespace std;
/*
    Time Complexity - O(n).
    Note: set_symmetric_difference() works only on sorted ranges. Applicable to sorted containers like sets, maps, sorted arrays , sorted vectors etc.,
    ...
    set_symmetric_difference() Constructs a sorted range beginning in the location pointed by result with the set symmetric_difference of the two sorted ranges 
...
int main(){
    ...
    sort(a,a+5);
    sort(b,b+5);
    auto it=set_symmetric_difference(a,a+5,b,b+5,v.begin());
    v.resize(it-v.begin());
    for(auto i:v)cout<<i<<" ";
    cout<<endl;
